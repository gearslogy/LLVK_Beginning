    ...
    for (const auto &mesh: model.meshes) {
        ...
        for (auto &&[part_id,primitive]: UT_Fn::enumerate(mesh.primitives)) {
            ...
            for(auto &[key, value]: primitive.attributes) {
                ...
                const tinygltf::Accessor &accessor = model.accessors[primitive.attributes.find(key)->second];

                if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_BYTE) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_BYTE\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_UNSIGNED_BYTE) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_UNSIGNED_BYTE\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_SHORT) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_SHORT\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_UNSIGNED_SHORT) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_UNSIGNED_SHORT\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_INT) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_INT\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_UNSIGNED_INT) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_UNSIGNED_INT\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_FLOAT) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_FLOAT\n";
                }
                else if (accessor.componentType==TINYGLTF_COMPONENT_TYPE_DOUBLE) {
                    std::cout << key << " componentType:" << "TINYGLTF_COMPONENT_TYPE_DOUBLE\n";
                }else {
                    std::cout << key << " componentType:" << "UNKNOWN ERROR\n";
                }
            }
